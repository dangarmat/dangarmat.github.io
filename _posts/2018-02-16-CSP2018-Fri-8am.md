...
Data linkage processes can enhance review and quality control process. They link on birth year, sex and first name. Interestingly first name is a function of birth year and sex, so they aggregate it to just the first initial. They found this aggregation method was necessary for working with relatively big data without proper tools to handle it, but disguised issues at a more granular level. 

One big change they made for the most recent run of this linkage was to make the upper cutoff of birth year higher at 1990+ instead of 1965+. So everyone who was born after that year in both data sets is in one categorical group. They had to investiage how this affected the quality of the linking, and these sets of box plots with year on the y-axis and weight on the x-axis show how much the distriubtion changed by this choice of feature engineering. Each point is a different first name. Can see this is one tab "FName by DOB Year" of their QA data visualization dashboard. 

![Boxplots of weight of age variable](/images/boxplots01.png "Boxplots showing how weights changed")

With further analysis 2011 vs. 2015 distributions and summary statistics, they ultimately concluded the change was neccessary to maintain the quality of past data linkages.
