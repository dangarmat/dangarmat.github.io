...
He went through it with his Medicaid data example, and ended up with results similar to original, which is not always the case. Further diagnostics are available to assess MAR assumption and to asses distributions of imputed data. So he concludes MICE is a viable method to address missing data in EHRs. 
