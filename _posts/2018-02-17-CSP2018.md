...
He took time series data on donations to a projects on a Kenyan GoFundMe type site and looked for clusterings using two methods: Dynamic Time Warping (DTW) and k-Shapes. He uses cumulative sums, not daily donation amounts as the y-value.
